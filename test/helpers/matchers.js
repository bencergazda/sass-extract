...
function toMatchSassVariable(variableType, received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  let sourceFile, variableDefinition
  if (typeof sourceFileOrVariableDefinition === "object" && !Array.isArray(sourceFileOrVariableDefinition)) {
  ...
  const sourceFiles = sourceFile ? (Array.isArray(sourceFile) ? sourceFile : [sourceFile]) : undefined
  const objectToMatch = {
    type: variableType,
    ...variableDefinition,
  }
...
function toMatchSassString(received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  return toMatchSassVariable("SassString", received, sourceFileOrVariableDefinition, backupVariableDefinition)
}

function toMatchSassNumber(received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  return toMatchSassVariable("SassNumber", received, sourceFileOrVariableDefinition, backupVariableDefinition)
}

function toMatchSassBoolean(received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  return toMatchSassVariable("SassBoolean", received, sourceFileOrVariableDefinition, backupVariableDefinition)
}

function toMatchSassList(received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  return toMatchSassVariable("SassList", received, sourceFileOrVariableDefinition, backupVariableDefinition)
}

function toMatchSassColor(received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  return toMatchSassVariable("SassColor", received, sourceFileOrVariableDefinition, backupVariableDefinition)
}

function toMatchSassMap(received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  return toMatchSassVariable("SassMap", received, sourceFileOrVariableDefinition, backupVariableDefinition)
}

function toMatchSassNull(received, sourceFileOrVariableDefinition, backupVariableDefinition) {
  return toMatchSassVariable("SassNull", received, sourceFileOrVariableDefinition, backupVariableDefinition)
}
