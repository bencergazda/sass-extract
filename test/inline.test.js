...
const testSets = [
  ...
  ['inline-nested', inlineNestedData, [inlineNestedPath], inlineNested1File, 'data', inlineNested2File]
]

describe('inline', () => {
  describe.each(testSets)('%s', (_, data, includePaths, number1Source, number2Source, colorSource) => {
